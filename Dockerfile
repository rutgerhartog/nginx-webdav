...
LABEL org.opencontainers.image.vendor "Eenden"
...
# Install nginx and webDAV extensions, then configure nginx with the setup script
RUN apk add -U nginx nginx-mod-http-dav-ext && sh setup.sh 
